...
// The Bank is full of rewards and rena.
// The longer you stay, the more RENAs you end up with when you leave.
// This contract handles swapping to and from xRenaToken <> RenaToken
contract Bank is ERC20 {
    ...
    // Enter the bank. Deposit some RENAs. Earn some shares.
    ...
    // Leave the bar. Claim back your RENAs.
